...
# Dump() method json files par hi kaam karta hai aur python objects ko ek argument ki tarah 
# store karta hai. 
# *Example:-*python object(dictionary) ko hum json file mai dump karenge.
import json
